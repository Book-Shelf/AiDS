...
class Set {
    ...
    // dodanie wybranego elementu do zbioru
    void Insert(T value) {
    ...
    // pobranie i usuniecie ze zbioru wybranego elementu
    T Pop(T x) {
    ...
    // sprawdzenie czy element nalezy do zbioru, zwraca iterator
    ...
    // sprawdzenie czy element nalezy do zbioru, zwraca bool
    bool IsMember(T x) {
